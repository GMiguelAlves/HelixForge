...
PREFLIGHT = ROOT / "benchmark/chipseq/scripts/real_broad/collect_real_broad_preflight.py"
...
EVALUATION_SLURM = ROOT / "benchmark/chipseq/scripts/real_broad/slurm_evaluate_real_broad.sh"
FIGURE_RENDERER = ROOT / "benchmark/chipseq/scripts/real_broad/render_real_broad_figures.py"
AUDIT_PACKAGER = ROOT / "benchmark/chipseq/scripts/real_broad/package_real_broad_audit.sh"
AUDIT_SNAPSHOT = ROOT / "benchmark/chipseq/scripts/real_broad/prepare_real_broad_audit_snapshot.sh"
CLEANUP = ROOT / "benchmark/chipseq/scripts/real_broad/slurm_cleanup_real_broad_benchmark.sh"
...
class RealBroadBenchmarkTests(unittest.TestCase):
    ...
    def test_cleanup_is_guarded_by_verified_home_audit(self):
        ...
        expected = "/scratch/HELIXFORGE_WORKSPACE/helixforge-chipseq-real-broad-benchmark-20260830"
