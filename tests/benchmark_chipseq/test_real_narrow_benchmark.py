...
SCRIPT = ROOT / "benchmark/chipseq/scripts/real_narrow/collect_real_narrow_metadata.py"
HELIXFORGE_RUNNER = ROOT / "benchmark/chipseq/scripts/real_narrow/run_real_narrow_helixforge.sh"
