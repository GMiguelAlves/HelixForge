...
class FullCoordinatorTopologyTest(unittest.TestCase):
    ...
    def test_full_mode_is_native_and_single_session(self):
        ...
        self.assertNotIn("LEGACY_STEP", workflow)
        self.assertNotIn("chipseq_native_", workflow)
        self.assertIn("CHIPSEQ_NATIVE_FOUNDATION(config_file, pipeline_root, seed)", workflow)
