...
RN3 is frozen as
`NOT_EVALUABLE_UNDER_FROZEN_CONTROL_REQUIREMENTS`. Do not use these scripts to
generate a new p-value for the v1.0.0-rc.1 baseline. Any future null model must
be designed and validated as an independent post-v1 methods investigation.
