...
python "$repo_root/benchmark/chipseq/scripts/collect_synthetic_broad_outputs.py" \
...
python "$repo_root/benchmark/chipseq/scripts/evaluate_synthetic_broad.py" \
...
bash "$repo_root/benchmark/chipseq/scripts/slurm_evaluate_broad_coverage.sh" \
