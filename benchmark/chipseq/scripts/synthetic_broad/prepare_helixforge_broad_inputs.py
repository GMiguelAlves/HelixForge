#!/usr/bin/env python3
"""Create HelixForge metadata/context files for the frozen synthetic broad dataset."""
...
def main() -> None:
    ...
    definitions = (
        ...
        ("chip_rep1", "synthetic_broad", "synthetic_factor", "1", "false", "input"),
        ("chip_rep2", "synthetic_broad", "synthetic_factor", "2", "false", "input"),
    )
        ...
        rows.append(
            {
                ...
                "lane": "L001",
                "dataset": "chipseq-synthetic-broad-v1",
                "organism": "synthetic",
    ...
    manifest = {
        "schema_version": "1.0",
        "type": "helixforge_synthetic_broad_input",
