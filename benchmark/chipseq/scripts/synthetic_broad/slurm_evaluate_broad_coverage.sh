...
python "$repo_root/benchmark/chipseq/scripts/synthetic_broad/prepare_broad_coverage_bins.py" \
...
python "$repo_root/benchmark/chipseq/scripts/synthetic_broad/evaluate_broad_coverage.py" \
