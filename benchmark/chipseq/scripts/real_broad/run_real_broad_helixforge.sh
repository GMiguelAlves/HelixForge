...
expected_root=/scratch/HELIXFORGE_WORKSPACE/helixforge-chipseq-real-broad-benchmark-20260830
...
if [[ "$mode" == resume ]]; then
    ...
    "$runtime_prefix/bin/python" "$repo_root/benchmark/chipseq/scripts/real_broad/prepare_helixforge_real_broad_inputs.py" \
