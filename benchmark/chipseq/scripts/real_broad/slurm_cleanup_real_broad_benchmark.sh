...
readonly ROOT="/scratch/HELIXFORGE_WORKSPACE/helixforge-chipseq-real-broad-benchmark-20260830"
readonly AUDIT_DIR="/home/CLUSTER_USER/helixforge-audit/real-broad"
...
[[ -d "$ROOT" ]]
[[ "$(realpath -- "$ROOT")" == "$ROOT" ]]
[[ "$ROOT" == /scratch/HELIXFORGE_WORKSPACE/helixforge-chipseq-real-broad-benchmark-20260830 ]]
