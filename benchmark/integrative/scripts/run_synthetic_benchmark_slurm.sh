...
case "$scratch_root" in
    /scratch/HELIXFORGE_WORKSPACE/helixforge-integrative-synthetic-*) ;;
...
if [[ "$mode" == finalize ]]; then
    ...
    python3 "$repo_root/benchmark/integrative/scripts/finalize_synthetic_benchmark.py" \
        ...
        --audit-archive "/home/CLUSTER_USER/helixforge-audits/helixforge-integrative-synthetic-10b-20260901.zip"
    exit 0
fi
