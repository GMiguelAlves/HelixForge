...
conda_root=${HELIXFORGE_CONDA_ROOT:-/home/CLUSTER_USER/miniconda3}
java_bin=${HELIXFORGE_JAVA:-${conda_root}/envs/rna-tools/bin/java}
nextflow_jar=${HELIXFORGE_NEXTFLOW_JAR:-/home/CLUSTER_USER/helixforge-validation-20260811/.validation-runtimes/nxf-home-25.10.7/framework/25.10.7/nextflow-25.10.7-one.jar}
baseline_audit=${HELIXFORGE_10B_AUDIT:-/home/CLUSTER_USER/helixforge-audits/helixforge-integrative-synthetic-10b-20260901.zip}
mode=${1:-driver}

case "$scratch_root" in
    /scratch/HELIXFORGE_WORKSPACE/helixforge-integrative-reentry-*) ;;
...
audit_archive="/home/CLUSTER_USER/helixforge-audits/helixforge-integrative-reentry-10c-20260901.zip"
