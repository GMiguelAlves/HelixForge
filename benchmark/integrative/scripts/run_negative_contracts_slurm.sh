...
python_bin=${HELIXFORGE_PYTHON:-/home/CLUSTER_USER/miniconda3/envs/rna-tools/bin/python}
audit_archive=${HELIXFORGE_AUDIT_ARCHIVE:-/home/CLUSTER_USER/helixforge-audits/helixforge-integrative-negative-contracts-10e-20260901.zip}
mode=${1:-driver}

case "$scratch_root" in
    /scratch/HELIXFORGE_WORKSPACE/helixforge-integrative-contracts-*) ;;
