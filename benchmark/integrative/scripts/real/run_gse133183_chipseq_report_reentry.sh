...
db_results=${HELIXFORGE_DB_RESULTS:-$case_root/results/120-differential-binding/differential_binding_results/contrasts/$analysis/GSK343_vs_DMSO/differential_binding_results.tsv}
contrast_spec=${HELIXFORGE_CONTRAST_SPEC:-$case_root/db_spec.json}
