...
#SBATCH --output=/scratch/HELIXFORGE_WORKSPACE/helixforge-integrative-real-20260901/logs/%x.%j.out
#SBATCH --error=/scratch/HELIXFORGE_WORKSPACE/helixforge-integrative-real-20260901/logs/%x.%j.err
set -euo pipefail
...
test -f /home/CLUSTER_USER/miniconda3/etc/profile.d/conda.sh
test -x /home/CLUSTER_USER/miniconda3/envs/python-list/bin/python
test -x /home/CLUSTER_USER/miniconda3/envs/r-analysis/bin/Rscript
test -x /home/CLUSTER_USER/miniconda3/envs/rna-tools/bin/salmon
