...
EXPECTED_SCRATCH = Path("/scratch/HELIXFORGE_WORKSPACE/helixforge-rnaseq-benchmark-20260825")
EXPECTED_AUDIT = Path("/home/CLUSTER_USER/helixforge-rnaseq-benchmark-audits/20260825-9b1")
FAILED_CASES = (
    "synthetic-primary",
