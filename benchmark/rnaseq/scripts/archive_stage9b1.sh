...
test -n "${SLURM_JOB_ID:-}"
expected_scratch=/scratch/HELIXFORGE_WORKSPACE/helixforge-rnaseq-benchmark-20260825
expected_audit=/home/CLUSTER_USER/helixforge-rnaseq-benchmark-audits/20260825-9b1
...
trap '[[ -n "${stage:-}" && "$stage" == /scratch/HELIXFORGE_WORKSPACE/helixforge-rnaseq-benchmark-20260825/audit-stage.* ]] && rm -rf -- "$stage"' EXIT
